...
{
    [Collection(nameof(DoacaoFixtureCollection))]   //agrupando colecoes de teste 
    public class DoacaoTests: IClassFixture<DoacaoFixture>, 
                              IClassFixture<EnderecoFixture>, 
                              IClassFixture<CartaoCreditoFixture>
    {
        //declarando fixtures que seram utilizadas mais a frente
        ...
        [Theory]//teoria
        [InlineData(0)]//sequencia de testes que sera rodado sobre o cenario a seguir
        [InlineData(-10)]
        [InlineData(-5)]
        [InlineData(-10.20)]
        [InlineData(-55.4)]
